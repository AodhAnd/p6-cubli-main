\begin{tikzpicture}[ auto,
                     ...
                     scale=1.5,                     %<--|these two scales the whole thing
  ...
  \draw%--------------------------------------------------------------------------------------------
  	...
  	%{$\sum$}                         ...writes a sumation symbol inside the circle
  ...
  %Joining the Blocks
  %When using \draw with options like [->], each line must be inclosed as follows:
