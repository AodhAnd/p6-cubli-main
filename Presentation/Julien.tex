...
\begin{frame}{Parameter Estimation}{Fibonacci Line Search}
  \begin{minipage}{\linewidth}
    \begin{minipage}{0.35\linewidth}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[scale=0.35]{Pictures/fibonacciIntervalSystem0}
      \end{figure}
      }
      \only<2>{
      \begin{figure}[H]
        \centering
        \includegraphics[scale=0.35]{Pictures/fibonacciIntervalSystem1}
      \end{figure}
      }
      \only<3>{
      \begin{figure}[H]
        \centering
        \includegraphics[scale=0.35]{Pictures/fibonacciIntervalSystem2}
      \end{figure}
      }
      \only<4->{
      \begin{figure}[H]
        \centering
        \includegraphics[scale=0.35]{Pictures/fibonacciIntervalSystem3}
      \end{figure}
      }
    \end{minipage}
    \hspace{0.03\linewidth}
